const services = [
  ...
  { title: 'Landscape Lighting', copy: 'Enhance beauty, safety, and security at night.', image: '/images/lighting.jpg' }
];
    ...
    <main>
      <header className="header">
        <a className="brand" href="#top">
          <img src="/logo.jpg" alt="Sonoran Turf & Gravel logo" />
        ...
        <nav>
          ...
          <a href="#contact" className="estimate">Free Estimate</a>
        </nav>
      </header>
      ...
      <section id="top" className="hero">
        ...
        <div className="heroInner">
          ...
          <div className="actions">
            ...
            <a href="#vision" className="button outline">Reimagine My Yard →</a>
          </div>
        </div>
        <div className="stats">
      ...
      <section id="vision" className="vision">
        <div>
          ...
          <p>Upload a photo, choose a design style, and receive a premium concept direction for your future outdoor space.</p>
        </div>
        <form>
      ...
      <section id="gallery" className="gallery">
        <p className="eyebrow center">Gallery Preview</p>
        <h2>Designed for Arizona Living</h2>
        <div className="galleryGrid">
          <img src="/images/after.jpg" alt="Luxury backyard concept" />
          <img src="/images/before.jpg" alt="Outdoor living concept" />
        </div>
      </section>
